...
/**
 * Thrown when an error occurs within the client. These are typically
 * programming or configuration errors.
 * 
 * @author <a href="http://efsavage.com">Eric F. Savage</a>, <a
 *         href="mailto:code@efsavage.com">code@efsavage.com</a>.
 */
public class ShopifyClientException extends Exception {
	 ...
	 */
	public ShopifyClientException(final Throwable t) {
		super(t);
	}
